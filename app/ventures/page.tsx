const ventures = [
  {
    name: "Operations and Systems Venture",
    focus: "Process improvement and digital systems execution",
    summary:
      "Designing and implementing practical systems that improve operational performance and visibility.",
    stage: "Active",
  },
  {
    name: "Technology Product Initiative",
    focus: "Product validation and technical delivery",
    summary:
      "Building and refining software concepts with a focus on reliability, user value, and scalable architecture.",
    stage: "In Progress",
  },
  {
    name: "Multi-Sector Service Model",
    focus: "Cross-domain problem solving",
    summary:
      "Applying engineering thinking to service delivery models across different industries and business contexts.",
    stage: "Developing",
  },
];
      ...
      <div className="relative mx-auto max-w-6xl">
        <section className="rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 via-slate-900/95 to-cyan-950/55 p-8 shadow-2xl shadow-cyan-950/40 md:p-12">
          ...
          <h1 className="mt-3 text-4xl font-bold tracking-tight md:text-5xl">
            Building ventures with technical depth and execution discipline
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-slate-300 md:text-lg">
            This section highlights business and product initiatives where I
            combine engineering, systems thinking, and practical operations.
          </p>
        </section>

        <section className="mt-14">
          <h2 className="text-3xl font-semibold tracking-tight">Current Focus</h2>
